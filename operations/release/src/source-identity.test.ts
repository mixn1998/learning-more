...
describe('release source identity', () => {
  it('separates product inputs from engineering, tests, and generated output', () => {
    expect(isProductSourcePath('apps/server/src/main.ts')).toBe(true);
    expect(isProductSourcePath('operations/maintenance/src/main.ts')).toBe(true);
    expect(isProductSourcePath('prompts/registry.json')).toBe(true);
    expect(isProductSourcePath('package.json')).toBe(true);
