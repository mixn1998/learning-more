...
- `apps/host/src/launcher-process.ts`: removes the obsolete negative browser environment flag.
...
- [ ] **Step 1: Make Launcher startup expectations browser-free**
...
- [ ] **Step 2: Add a failing local adapter regression**
...
- [ ] **Step 3: Run the focused Launcher tests and confirm red**
...
- [ ] **Step 4: Remove browser capability from Launcher implementation**
...
In `apps/launcher/src/main.ts`, remove the `openBrowser` option when creating local adapters. In `apps/host/src/launcher-process.ts`, remove the now-obsolete `LEARNING_MORE_NO_OPEN` environment entry.

- [ ] **Step 5: Run Launcher tests and typecheck green**
...
- [ ] **Step 2: Run wrapper tests and confirm missing module failure**
...
- [ ] **Step 4: Make the executable entry thin and explicit**
...
- [ ] **Step 5: Run wrapper and root tests**
...
- [ ] **Step 6: Commit the explicit wrapper**
...
- [ ] **Step 1: Write portable script contract tests**
...
- [ ] **Step 3: Implement deterministic portable commands**
...
- [ ] **Step 4: Update portable documentation**
...
- [ ] **Step 6: Commit portable behavior**
...
- [ ] **Step 1: Run all scoped tests and builds**
...
- [ ] **Step 2: Capture and verify the orphan process tree**
...
- [ ] **Step 3: Stop only the verified orphan and repair Host**
...
- [ ] **Step 4: Verify task and process ownership**
...
- Host parent service is Windows `Schedule`;
...
- [ ] **Step 5: Verify no implicit browser path remains**
