  ...
  return (
    <LessonRecordView
      ...
      original={{
        ...
        messages: [
          '导师：回想你提到的平台跳跃原型：玩家在第几分钟开始觉得重复？你当时看到了什么行为证据？',
          '你：大概第三分钟。玩家还在继续跳，但已经不再尝试收集边缘位置的金币，动作变得很机械。',
          '导师：这说明问题不只是“内容数量少”，而是玩家已经不需要重新判断。我们可以把体验断点拆成三个维度：行动是否变化、反馈是否带来新信息、目标是否继续推进。',
          '你：应该是反馈没有新信息。金币只是加分，没有改变玩家接下来怎么跳。',
          '导师：很好。你已经从“重复感”推进到了可设计的问题：反馈有没有改变下一次行动。',
        ],
      }}
      ...
      supplementary={[
        {
          ...
          messages: [
            '你：如果边缘金币临时提高跳跃高度，它是不是能改变路线判断？',
            '导师：关键不在奖励更强，而在玩家是否会因此重新比较路线；路线选择变化才是更直接的证据。',
          ],
        },
      ]}
      title="玩家为什么会停下来"
