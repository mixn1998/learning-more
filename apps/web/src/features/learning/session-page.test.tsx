...
describe('learning SessionPage', () => {
  ...
  it('reuses the lesson start request when React StrictMode replays effects', async () => {
    ...
    render(
      <StrictMode>
        <SessionPage lessonId="lesson_01" client={api} />
      </StrictMode>,
    );

    expect(await screen.findByLabelText('学习输入')).toBeEnabled();
