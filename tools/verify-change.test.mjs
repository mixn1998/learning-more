...
describe('affected verification planner', () => {
  it('keeps documentation-only changes local to formatting', () => {
    expect(
      planAffectedVerification(repositoryRoot, [
        'docs/superpowers/specs/2026-07-27-change-aware-verification-design.md',
      ]),
    ).toMatchObject({
      formatFiles: ['docs/superpowers/specs/2026-07-27-change-aware-verification-design.md'],
      lintFiles: [],
      relatedTestSources: [],
      typecheckPackages: [],
      gates: [],
  ...
  it('escalates verification framework and root configuration changes', () => {
    expect(planAffectedVerification(repositoryRoot, ['tools/verify-change.mjs']).fullReason).toBe(
      'verification_framework_changed',
    );
